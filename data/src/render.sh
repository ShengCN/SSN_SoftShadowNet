...
# python render.py --cpus=$cpus --gpus 0 1 3 --ds_root=$ds_root --out_folder=$cache --start_id=$start_id --end_id=$end_id --width=$width --height=$height --cam_pitch 15 30 45 --model_rot -45 0 45
