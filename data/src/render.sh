...
width=512
height=512
out_hdf5="./base/dataset.hdf5"

# python render.py --cpus=4 --gpus=0 --ds_root=$ds_root --out_folder=$cache --start_id=$start_id --end_id=$end_id --width=$width --height=$height --cam_pitch 15 --model_rot 0
