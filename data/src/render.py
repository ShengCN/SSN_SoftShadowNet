...
def worker(input):
    ...
    cmd = 'build/shadow_base --model={} --output={} --cam_pitch=30 --model_rot=-45 --render_mask --render_height --render_normal --render_shadow --gpu={} --width=512 --height=512 --ibl_w=256 --ibl_h=512'.format(model_path, out_path, gpu)
    os.system(cmd)
